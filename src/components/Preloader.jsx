...
const Preloader = () => {
  return (
    <motion.div
      ...
      className="fixed inset-0 bg-charcoal-900 flex items-center justify-center z-50"
    >
      <div className="text-center">
        ...
        <motion.p
          ...
          className="text-gold-400 text-sm tracking-[0.3em] mb-8"
        >
        ...
        <motion.p
          ...
          className="text-white/50 text-xs mt-4 tracking-widest"
        >
